<?php
/**
 * Template Name: Landing Page Template B with ACF
 *
...
?>
    ...
    <!-- Hero -->
    <div class="wrapper py-5 color-radial-gradient-semi-dark text-inverse shadow">
        <div class="container py-5">
            <div class="row justify-content-between align-items-center py-5">
                <div class="col-md-7">
                    <div class="row">
                        <div class="col-md-12 align-items-center py-3 text-shadow-black">
                            <?php the_field('hero-headline'); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 align-items-center pb-3">
                            <a href="<?php the_field('cta-url'); ?>" class="btn cta-button-dark text-large zoom"><h3
    ...
    <div class="wrapper py-0 color-grey-light">
        <div class="container  pt-2 pb-5 ">
            <div class="row justify-content-between text-center align-items-stretch pt-5 pb-4">
                <div class="col-md-12">
                    <?php the_field('three-cards-text'); ?>
                </div>
            </div>
            <div class="row justify-content-between align-items-stretch pb-3">
                <div class="col-md-4 px-2">
                    <div class="card card-default zoom">
                        <div class="card-body"><?php the_field('three-cards-1'); ?></div>
                    </div>
                </div>
                <div class="col-md-4 px-2">
                    <div class="card card-default zoom">
                        <div class="card-body"><?php the_field('three-cards-2'); ?></div>
                    </div>
                </div>
                <div class="col-md-4 px-2">
                    <div class="card card-default zoom">
                        <div class="card-body"><?php the_field('three-cards-3'); ?></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="wrapper py-0">
                        <div class="container  py-5 ">
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-md-5">
                                    <img class="img-fluid rounded shadow" src="<?php the_field('squeeze-image-A'); ?>"/>
                                </div>
                            </div>
                        </div>
                    </div>
